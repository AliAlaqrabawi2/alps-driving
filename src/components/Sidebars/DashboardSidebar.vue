<template>
  ...
  >
    ...
    <a-menu
      theme="light"
      mode="inline"
      v-for="(items, i) in MenuConfig"
      :key="i"
    >
      <a-menu-item class="menu-item-header">{{ items.heading }}</a-menu-item>
      <a-menu-item v-for="(page, i) in items.pages" :key="i">
        <router-link :to="page.route">
          ...
          <span class="label">{{ page.sectionTitle }}</span>
        </router-link>
      </a-menu-item>
    </a-menu>
    <!-- / Sidebar Navigation Menu -->
